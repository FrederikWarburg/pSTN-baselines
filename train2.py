...
# simple pstn
# python train2.py --dataroot /scratch/s153847/ --model pstn --basenet simple --dataset mnist --digits 2 --N 2 --train_samples 1 --test_samples 10 --batch_size 256 --num_classes 10 --step_size 100000 --smallest_size 64 --crop_size 64 --lr_loc 1e-02 --seed 42 --lr 0.1 --criterion elbo
